    ...
    The project located in this directory has been generated by Leandro Hermida
    ...
    that a model called 'fuge-ejb3-stk' has been created within your Magic Draw model.

    Important: before launching AndroMDA, be sure to have exported your model.

    /fuge-ejb3-stk J2EE project
         |
    ...
    this might be a directory looking like this:
        ...
        (*nix)
        /home/Leandro Hermida/.m2/repository/fuge-ejb3-stk/
